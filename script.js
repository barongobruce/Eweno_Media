...
(function () {
  ...
  function initHeroParallax() {
    ...
    if (isMobile) {
      ...
      heroImage.src = 'images/hero5.webp'; 
  ...
  function initBookingForm() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      var waText = "Hello Eweno I would like to make a booking.%0A%0A" +
                   "*Name:* " + name + "%0A" +
                   "*Email:* " + email + "%0A" +
                   "*Phone:* " + phone + "%0A" +
                   "*Service:* " + service + "%0A" +
...
function initWhatsAppBooking() {
  ...
  form.addEventListener('submit', function(e) {
    ...
    var whatsappMessage = 
      ...
      'Sent from Brucee Focus digital website';
    
    // Your WhatsApp number (replace with actual number)
    var whatsappNumber = '254710802808'; // Format: country code + number (no + or spaces)
